...
description: Aprenda a añadir el registro de verificación del sitio TXT de Google a los subdominios utilizados para enviar correos electrónicos a las direcciones de GMAIL a través del Panel de control de Campaign de Campaign.
...
Obtenga información sobre cómo añadir [!UICONTROL Google TXT] registros de verificación del sitio a todos los subdominios utilizados para enviar correos electrónicos a [!DNL GMAIL] direcciones con [!UICONTROL Campaign Control Panel].
